...
| `drop_preview_test` | Lógica do preview de drop (`drawDropPreview`): verde/vermelho no cursor, snap no 1º espaço livre só em OUTRO grid (mesmo grid é estrito), ignoreSet de itens em movimento | 13 |
